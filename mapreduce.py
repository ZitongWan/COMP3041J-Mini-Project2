...
def aggregate_service_stats(data):
    """
    Aggregate per-service statistics for Ray degraded detection.

    Returns:
        dict: {service_name: {total, slow, error, timeout, bad_gateway,
